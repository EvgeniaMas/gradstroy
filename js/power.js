...
(function() {
  var questions = [
    ...
    {
    question: "<p>Какая <span>этажность</span> у вашего будущего дома?</p></div>",
    answers:"<div class='col-md-12'><div class='col-md-4'><img src='../img/one.jpg'><input id='floor' type='checkbox' name='floor' onClick='get_floor()'>"
